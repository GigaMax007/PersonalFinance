...
public class Format {
    ...
    private static String dateFormat(Date date, String format) {
        SimpleDateFormat sdf = new SimpleDateFormat(format, new mainDatеFormatSymbols());
...
// В этом классе переопределим названия месяцев
    private static class mainDatеFormatSymbols extends DateFormatSymbols {
        @Override
