...
public final class FunctionsToolBar extends AbstractToolBar implements EnableEditDelete {
    ...
    @Override
    protected void init() {
        addButton(Text.get("TOOLBAR_ADD"), Style.ICON_ADD, HandlerCode.ADD, false);
        editButton = addButton(Text.get("TOOLBAR_EDIT"), Style.ICON_EDIT, HandlerCode.EDIT, false);
        deleteButton = addButton(Text.get("TOOLBAR_DELETE"), Style.ICON_DELETE, HandlerCode.DELETE, false);
    }
